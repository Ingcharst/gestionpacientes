"""
Vistas para procedimientos (frontend) - CORREGIDO
"""
...
def paciente_editar(request, pk):
    ...
    context = {
        'form': form,
        'object': paciente,  # Importante: cambiar de 'paciente' a 'object'
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            try:
                ...
                return redirect('procedimientos:sesion_detail', pk=sesion.pk)
            except Exception as e:

...
class CodigoEnfermedad(models.Model):
    """Catálogo CIE-10"""
    ...
    class Meta:
        verbose_name = 'Código de Enfermedad'
        verbose_name_plural = 'Códigos de Enfermedad'
        ordering = ['codigo']
...
"""
    ...
    # Deprecar estos campos (agregar null=True, blank=True):

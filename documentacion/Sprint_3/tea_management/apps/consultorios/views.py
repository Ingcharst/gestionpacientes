...
def consultorio_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('consultorio_detail', pk=consultorio.pk)
    else:
...
def consultorio_update(request, pk):
    ...
    if not (request.user.es_admin or request.user.puede_gestionar_terapias):
        ...
        return redirect('consultorio_detail', pk=pk)
...
def sala_create(request, consultorio_pk):
    ...
    if not (request.user.es_admin or request.user.puede_gestionar_terapias):
        ...
        return redirect('consultorio_detail', pk=consultorio_pk)
...
def sala_update(request, pk):
    ...
    if not (request.user.es_admin or request.user.puede_gestionar_terapias):
        ...
        return redirect('consultorio_detail', pk=sala.consultorio.pk)
...
def asignacion_list(request):
    ...
    solo_vigentes = request.GET.get('vigentes')
...
def asignacion_update(request, pk):
    ...
    if not (request.user.es_admin or request.user.puede_gestionar_terapias):
        ...
        return redirect('asignacion_detail', pk=pk)

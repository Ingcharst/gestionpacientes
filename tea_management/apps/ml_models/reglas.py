...
class FiltrosReglas:
    ...
    def aplicar_filtros(self, grupos, paciente, valoracion=None):
        """
        Filtra grupos según reglas de negocio
        ...
        for grupo in grupos:
            ...
            # FILTRO 3: Nivel de funcionamiento (si hay valoración)
            if valoracion and not self._nivel_compatible(valoracion, grupo):
                continue

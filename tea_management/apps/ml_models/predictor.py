...
# resultado = recomendador.recomendar_grupos(paciente_instance, valoracion=valoracion_instance, top_n=3)
# for rec in resultado['recomendaciones']:
#     print(f"Grupo: {rec['grupo'].nombre}, Score: {rec['score']}%, Disponible: {rec['disponible']}")
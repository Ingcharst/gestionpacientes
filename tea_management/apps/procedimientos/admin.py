...
class PacienteAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'numero_admision','numero_historia_clinica', 'nombre_completo_link', 'numero_documento',
    ...
    search_fields = [
        ...
        'diagnostico_principal', 'nombre_responsable', 'numero_admision'
    ]
    
    readonly_fields = [
        'numero_historia_clinica', 'edad', 'edad_meses', 'numero_admision',
    ...
    fieldsets = (
        ('Información Personal', {
            'fields': (
                'numero_admision','numero_historia_clinica', 'nombres', 'apellidos', 'nombre_completo',
...
class EvolucionPacienteAdmin(admin.ModelAdmin):
    ...
    def get_readonly_fields(self, request, obj=None):
        """Si la evolución está firmada, todos los campos son readonly"""
        if obj and obj.firmado:
            return [field.name for field in obj._meta.fields]
        return self.readonly_fields
    
    def has_delete_permission(self, request, obj=None):
        """No se puede eliminar si está firmada"""
        if obj and obj.firmado:
            return False

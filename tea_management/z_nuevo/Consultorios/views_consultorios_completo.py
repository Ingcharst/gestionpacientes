...
from apps.consultorios.models import Consultorio, Sala, AsignacionConsultorio, DisponibilidadConsultorio
...
def asignacion_detail(request, pk):
    ...
    asignacion = get_object_or_404(
        AsignacionConsultorio.objects.select_related('consultorio', 'terapeuta', 'terapia'),
        pk=pk
    )
